...
function MissingKey() {
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-6 font-sans">
      <div className="max-w-md w-full p-10 glass rounded-[3rem] border-indigo-500/20 text-center relative overflow-hidden">
        <div className="absolute -top-24 -left-24 w-64 h-64 bg-indigo-500/10 rounded-full animate-pulse-slow blur-3xl" />
        <div className="absolute -bottom-24 -right-24 w-64 h-64 bg-purple-500/10 rounded-full animate-pulse-slow blur-3xl" />
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/60 mb-8 leading-relaxed">
            ...
            <code className="mx-1 px-2 py-0.5 bg-white/10 rounded text-indigo-300">VITE_SUPABASE_URL</code> and 
            <code className="mx-1 px-2 py-0.5 bg-white/10 rounded text-indigo-300">VITE_SUPABASE_ANON_KEY</code>
